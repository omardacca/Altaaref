...
namespace AltaarefWebAPI.Controllers
{
    ...
    public class UserNotificationsController : Controller
    {
        ...
        public async Task<IActionResult> GetGeneralUserNotification([FromRoute] int StudentId)
        {
            ...
            var userNotification = _context.UserNotifications.Where(m => m.Topic == "GE" + StudentId.ToString());
        ...
        public async Task<IActionResult> GetUserNotificationByStudentId([FromRoute] int StudentId)
        {
            ...
            var userNotification = _context.UserNotifications.Where(m => m.StudentId == StudentId);
        ...
        public async Task<IActionResult> DeleteGeneralUserNotification([FromRoute] int StudentId)
        {
            ...
            var userNotification = await _context.UserNotifications.SingleOrDefaultAsync(m => m.Topic == "GE" + StudentId.ToString());
            if (userNotification == null)
            {
                return NotFound();
            }
