...
namespace AltaarefWebAPI.Migrations
{
    ...
    [Migration("20180606173657_AddRideCommentsTable1")]
    partial class AddRideCommentsTable1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AltaarefWebAPI.Models.RideComments", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<DateTime>("FullTime")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2018, 6, 6, 20, 36, 57, 580, DateTimeKind.Local));
                    ...
                    b.ToTable("RideComments");
                });

            modelBuilder.Entity("AltaarefWebAPI.Models.RidesInvitations", b =>
                {
                    b.Property<int>("RideId");
                    ...
                    b.HasKey("RideId", "CandidateId");

                    b.HasIndex("CandidateId");

                    b.ToTable("RidesInvitations");
                });
            ...
            modelBuilder.Entity("AltaarefWebAPI.Models.RidesInvitations", b =>
                {
                    b.HasOne("AltaarefWebAPI.Models.Student", "Candidate")
                        .WithMany("RideInvitations")
                        .HasForeignKey("CandidateId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("AltaarefWebAPI.Models.Ride", "Ride")
                        .WithMany("RidesInvitations")
                        .HasForeignKey("RideId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
